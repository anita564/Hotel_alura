...
public class EditBookingController implements Initializable, Validator {
    ...
    public void initData(Booking selectedReserva) {
        Integer id = selectedReserva.getId();
        String dateIn = selectedReserva.getCheckInDate();
        String dateOut = selectedReserva.getCheckOutDate();
        Double value = selectedReserva.getPriceValue();
        String wayToPay = selectedReserva.getPaymentMethod();
    ...
    private void updateBooking() {
        ...
        Booking reserva = new Booking(id, dateIn, dateOut, value, wayToPay);

        ControllerBooking reservaController = new ControllerBooking();
