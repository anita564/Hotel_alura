...
import main.hotel.hotelalura.controller.ControllerUser;
...
public class UserValidator {
    ...
    public static void userRegisterValidator(TextField input_name, TextField input_lastName, TextField input_email, TextField input_user, PasswordField input_password, PasswordField input_repeatPassword, Label text_error, Button btn_register, ControllerUser usuarioController) {
