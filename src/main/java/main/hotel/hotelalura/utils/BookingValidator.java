...
public class BookingValidator {
    public static void bookingValidator(DatePicker inputDateIn, DatePicker inputDateOut, TextField inputValue, ChoiceBox<WayToPay> inputWayToPay, 
    									Label textError, Button btnRegister) {
