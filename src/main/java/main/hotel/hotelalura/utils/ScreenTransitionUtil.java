...
public class ScreenTransitionUtil {
    ...
    public static void showScreenEditHost(Object currentController, String fxmlLocation, Host selectedHuespede, Button triggerButton) {
        try {
            FXMLLoader loader = new FXMLLoader(currentController.getClass().getResource(fxmlLocation));
    ...
    public static void showScreenEditBooking(Object currentController, String fxmlLocation, Booking selectedReserva, Button triggerButton) {
        try {
            FXMLLoader loader = new FXMLLoader(currentController.getClass().getResource(fxmlLocation));
            Parent root = loader.load();
